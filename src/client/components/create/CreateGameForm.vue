  ...
  data(): CreateGameModel {
    return {
      ...
      players: [
        ...
        {index: 2, name: 'Brannon', color: Color.GREEN, beginner: false, handicap: 0, first: false},
        {index: 3, name: 'Drew', color: Color.YELLOW, beginner: false, handicap: 0, first: false},
        {index: 4, name: 'Jacob', color: Color.BLUE, beginner: false, handicap: 0, first: false},
        {index: 5, name: 'Steve', color: Color.BLACK, beginner: false, handicap: 0, first: false},
